...
\subtitle{La gestion de paquets}
...
\begin{frame}[containsverbatim]
  \frametitle{En avance sur tout le monde\dots}
...
\begin{frame}[containsverbatim]
  \frametitle{La diversité des formats}
...
\begin{frame}[containsverbatim]
  \frametitle{Ajout d'une clef sous Debian/Ubuntu}
...
\begin{frame}[containsverbatim]
  \frametitle{Ajout d'un dépot sous Debian/Ubuntu}
...
\begin{frame}[containsverbatim]
  \frametitle{Recherche d'un paquet}
...
\begin{frame}[containsverbatim]
  \frametitle{Que faire avec un .deb ou un .rpm ?}
...
\begin{frame}[containsverbatim]
  \frametitle{Quand ça se passe mal sous Debian/Ubuntu\dots}
...
\begin{frame}[containsverbatim]
  \frametitle{L'entretien d'un système\dots}
...
\begin{frame}[containsverbatim]
  \frametitle{Utilitaires graphiques}
...
\begin{frame}[containsverbatim]
  \frametitle{Différence entre les distributions usuelles et \emph{ArchLinux}}

					
\end{frame}

\begin{frame}[containsverbatim]
  \frametitle{Retrouver sa version}
