...
\begin{frame}[containsverbatim]
  \frametitle{Les périphériques amovibles}
...
\begin{frame}[containsverbatim]
  \frametitle{Montage et démontage}
...
\begin{frame}[containsverbatim]
  \frametitle{Les principaux répertoire\dots}
...
\begin{frame}[containsverbatim]
  \frametitle{Les différents utilisateurs}
